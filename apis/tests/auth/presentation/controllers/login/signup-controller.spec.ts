...
import { ParameterInUseError, ServerError } from '@/common/presentation/errors';
...
import { mockAddPatientParams } from '@/tests/auth/domain/mocks';
import { AddPatientSpy, GenerateTokensSpy } from '@/tests/auth/presentation/mocks';
